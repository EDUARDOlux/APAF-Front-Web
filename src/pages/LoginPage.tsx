...
import { AccountLocked } from '../features/auth/components/AccountLocked';
import { useLockoutTimer } from '../features/auth/hooks/useLockoutTimer';

export function LoginPage() {
    const { isLocked } = useLockoutTimer();
